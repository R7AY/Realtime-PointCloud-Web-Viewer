...
const myVertexShader = `
  ...
  void main() {
    ...
    color = mix(vec3(1, 0, 0), vec3(0, 1, 0), intensity);
  ...
  parse(data) {
    ...
    if (PCDheader.data === "binary") {
      ...
      for (
        ...
        if (offset.intensity !== undefined) {
          intensity.push(
            dataview.getFloat32(row + offset.intensity, this.littleEndian) * (1/128.0)// (HXC 20230727)
          );
        }
